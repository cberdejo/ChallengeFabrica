...
public class Cuadro {
    ...
    public int getGrosorLijaByOrLija(OrLija orLija) {
        switch (orLija) {
            case OrLija.Norte:
    ...
    public void setGrosorLijaByOrLija(int grosor, OrLija orLija) {
        switch (orLija) {
            case OrLija.Norte:
                setGrosorLijaNorte(grosor);
                break;
            case OrLija.Sur:
                setGrosorLijaSur(grosor);
                break;
            case OrLija.Este:
                setGrosorLijaEste(grosor);
                break;
            case OrLija.Oeste:
                setGrosorLijaOeste(grosor);
                break;
            default:
                break;
        }
